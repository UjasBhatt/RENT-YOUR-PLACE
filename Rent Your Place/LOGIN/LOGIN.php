            ...
            <div class="row">
                ...
                <div class="col-sm-6 form">
                    ...
                    <div class="signup form-peice">
                        <form class="signup-form" action="book.html" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="pwd" id="password" class="pass">
                                <span class="error"></span>
                            </div>
                            ...
                            <div class="CTA">
                                <BUTTON type="submit" value="Signup" id="submit">SignI=UP</BUTTON>
